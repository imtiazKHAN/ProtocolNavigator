...
class RheometerStepBuilder(wx.ScrolledWindow):
	...
	for step in steps:
	    ...
	    #-- Widgets ---#
	    self.GrandParent.settings_controls[stepTAG+'|0'] = wx.TextCtrl(self, size=(200,-1), value=step_info[0], style=wx.TE_PROCESS_ENTER)
	    self.GrandParent.settings_controls[stepTAG+'|1'] = wx.TextCtrl(self, size=(30,-1), value=step_info[1], style=wx.TE_PROCESS_ENTER)
	    ...
	    #-- Binding ---#
	    self.GrandParent.settings_controls[stepTAG+'|0'].Bind(wx.EVT_TEXT, self.GrandParent.OnSavingData)
	    self.GrandParent.settings_controls[stepTAG+'|1'].Bind(wx.EVT_TEXT, self.GrandParent.OnSavingData)
	    self.GrandParent.settings_controls[stepTAG+'|2'].Bind(wx.EVT_TEXT, self.GrandParent.OnSavingData)
	    ...
	    self.fgs.Add(self.GrandParent.settings_controls[stepTAG+'|0'], 1, wx.EXPAND|wx.ALL, 5) 
	    self.fgs.Add(self.GrandParent.settings_controls[stepTAG+'|1'], 0, wx.ALIGN_CENTRE)
	    self.fgs.Add(self.GrandParent.settings_controls[stepTAG+'|2'], 0, wx.ALIGN_CENTRE)
